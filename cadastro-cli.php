    ...
    <div class="container">
        ...
        <div id="form" style="position:relative;left:250px;top:200px;">
            <form class="" action="cadastro-cli-funcao.php" method="post" style="border:2px solid black;padding:40px;border-radius:20px;">
                <p>Nome:<input type="text" name="nome" id="nome" style="height:30px;border-radius:10px;margin-left:10px;"></p><br>
                <p>Email:<input type="text" name="email" id="email" style="height:30px;border-radius:10px;margin-left:10px;"></p><br>
                <p>CPF:<input type="text" name="cpf" id="cpf" style="height:30px;border-radius:10px;margin-left:10px;"></p><br>
                <p>Telefone:<input type="text" name="telefone" id="telefone" style="height:30px;border-radius:10px;margin-left:10px;"></p><br>
